/* ============================================================
   GM MOTORS — shared inventory dataset
   Single source of truth for the SRP (and, later, the homepage).
   ============================================================ */
(function () {
  ...
  window.GM_INVENTORY = [
    { id: "sprinter753452", year: 2025, make: "Mercedes-Benz", model: "Sprinter 3500", trim: "170WB Extended · 15-Passenger", price: 129995, mileage: 25, drivetrain: "RWD", transmission: "9-Speed Automatic", body: "Passenger Van", color: "Obsidian Black Metallic", engine: "4-Cyl 2.0L Turbo Diesel", fuel: "Bio-diesel", interior: "Maturin Black", stock: "1187", image: VEH + "01.jpg", images: SPRINTER_1187, video: { src: "assets/video/CLAUDE.mp4", poster: VEH + "10.jpg" }, featured: true },
    ...
    { id: "firstclass",year: 2022, make: "Mercedes-Benz", model: "Sprinter 3500",   trim: "First-Class Lounge Conversion",   price: 139495, mileage: 18900,  drivetrain: "4MATIC", transmission: "7G-TRONIC",     body: "Luxury Conversion", color: "Obsidian Black", image: IMG + "van-10.jpg", status: "sold" },
    ...
    { id: "transit250",year: 2020, make: "Ford",          model: "Transit 250",     trim: "Medium Roof EcoBoost",            price: 32900,  mileage: 78400,  drivetrain: "RWD",    transmission: "10-Speed Auto", body: "Cargo Van",         color: "Magnetic Grey", image: IMG + "van-11.jpg", status: "sold" },
